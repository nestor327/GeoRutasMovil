  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      child: BlocListener<UserBloc, UserState>(
        ...
        child: Scaffold(
          body: BlocBuilder<UserBloc, UserState>(builder: (contex, state) {
            switch (state) {
              case UserInitial():
                return Column(
                  children: [
              ...
              case SignInLoading():
                return const Text("Estas intentando iniciar sesion");
              case SignInFailure(errorMessage: "Error de prueba"):
                return const Text("Inicio de sesion fallido");
              case SignInSuccess():
                return const Text("Inicio de sesion exitoso");
              default:
                return const Text("Error en el componente Login");
            }
          }),
        ),
      ),
