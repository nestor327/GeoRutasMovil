...
class CoordinateRoute extends StatefulWidget {
  const CoordinateRoute({super.key});

  @override
  State<CoordinateRoute> createState() => _CoordinateRouteState();
}

class _CoordinateRouteState extends State<CoordinateRoute> {
  List<Trip> viajes = [];
